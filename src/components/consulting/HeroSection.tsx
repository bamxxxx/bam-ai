      ...
      <div className="relative transform -rotate-1 md:transform-none">
        ...
        <div className="prose max-w-none bg-white p-4 md:p-8 rounded-lg shadow-lg relative transform rotate-0 font-['Caveat'] text-lg md:text-[1.75rem] leading-relaxed">
          ...
          <p className="mb-4">
            ...
            your unique business needs and <span className="bg-gradient-to-r from-purple-200/70 to-purple-300/70 inline-block px-1">implementing solutions that create real, measurable value.</span>
          </p>
          <p className="mb-6">
